...
val create_import : tenant_id:string -> user_id:string -> resource_type:string -> source_filename:string -> source_format:string -> auction_id:string option -> mapping:string -> staging_rows:string -> row_count:int -> valid_row_count:int -> invalid_row_count:int -> (string, error) result Lwt.t
